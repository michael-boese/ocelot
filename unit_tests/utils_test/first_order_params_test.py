...
def test_first_order_sbend_entrance(load_ground_truth_data):
    first_order_test(SBendAtom(l=0.200102663853, angle=-0.1109740393, e1=-0.05548702, e2=-0.05548702, tilt=1.570796327, fint=0.0, eid='BL.73.I1'), 'SBend_E1', load_ground_truth_data, tm_type=TMTypes.ENTRANCE)
...
def test_first_order_sbend_exit(load_ground_truth_data):
    first_order_test(SBendAtom(l=0.200102663853, angle=-0.1109740393, e1=-0.05548702, e2=-0.05548702, tilt=1.570796327, fint=0.0, eid='BL.73.I1'), 'SBend_E2', load_ground_truth_data, tm_type=TMTypes.EXIT)
...
def test_first_order_cavity_entrance(load_ground_truth_data):
    ...
    first_order_test(CavityAtom(l = 0.346, v = 0.0024999884, freq = 3.9e9, phi = 180.0, eid = 'C3.AH1.1.1.I1'), 'Cavity_CK1', load_ground_truth_data, tm_type=TMTypes.ENTRANCE)


def test_first_order_cavity_main(load_ground_truth_data):
    first_order_test(CavityAtom(l = 0.346, v = 0.0024999884, freq = 3.9e9, phi = 180.0, eid = 'C3.AH1.1.1.I1'), 'Cavity', load_ground_truth_data)
...
def test_first_order_cavity_exit(load_ground_truth_data):
    ...
    first_order_test(CavityAtom(l = 0.346, v = 0.0024999884, freq = 3.9e9, phi = 180.0, eid = 'C3.AH1.1.1.I1'), 'Cavity_CK2', load_ground_truth_data, tm_type=TMTypes.EXIT)
